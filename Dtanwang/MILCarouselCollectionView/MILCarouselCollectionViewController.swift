    ...
    */
    private func startTimer(){
        if(autoScrollingEnabled == true){
            self.timer =  NSTimer.scheduledTimerWithTimeInterval(self.timerInterval, target: self, selector: #selector(MILCarouselCollectionViewController.nextItem), userInfo: nil, repeats: true)
        }
    }

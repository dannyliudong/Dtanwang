    ...
    */
    ...
    func addImageToLioScrollView(urlArray:NSArray) {
        ...
        for index in 0..<urlArray.count {
            ...
            imageButton.addTarget(self, action: #selector(LioLoopView.imageButtonEvent(_:)), forControlEvents: UIControlEvents.TouchUpInside)
    ...
    func timerStart (){
       self.timer = NSTimer.scheduledTimerWithTimeInterval(3, target: self, selector: #selector(LioLoopView.timerEvent), userInfo: nil, repeats: true)
    }

...
class CirCleView: UIView, UIScrollViewDelegate {
    ...
    private func setUpCircleView() {
        ...
        currentImageView.frame = CGRectMake(self.frame.size.width, 0, self.frame.size.width, scrollViewHeight)
        ...
        lastImageView.frame = CGRectMake(0, 0, self.frame.size.width, scrollViewHeight)
        ...
        nextImageView.frame = CGRectMake(self.frame.size.width * 2, 0, self.frame.size.width, scrollViewHeight)
